...
exports.directMessageSubscription = exports.requireTeamAccess = exports.requireAuth = undefined;
...
var requireAuth = exports.requireAuth = createResolver(function (parent, args, _ref2) {
  var user = _ref2.user;

  if (!user || !user.id) throw new Error("Not authenticated!");
});

var requireTeamAccess = exports.requireTeamAccess = createResolver(function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            throw new Error("Only member can subscribe messages!");
