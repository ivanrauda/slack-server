...
exports.default = {
  Mutation: {
    getOrCreateChannel: _permissions.requireAuth.createResolver(function () {
              ...
              case 17:
                ...
                return models.sequelize.transaction(function () {
                  var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(transaction) {
                    var channel, cId, privateMembers;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          ...
                          case 2:
                            ...
                            privateMembers = allMembers.map(function (member) {
                              return {
                                userId: member,
                                channelId: cId
                              };
                            ...
                            _context.next = 7;
                            return models.PrivateMembers.bulkCreate(privateMembers, {
                              transaction: transaction
                            });
    ...
    createChannel: _permissions.requireAuth.createResolver(function () {
              ...
              case 6:
                ...
                return models.sequelize.transaction(function () {
                  var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(transaction) {
                    var channel, members, privateMembers;
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          ...
                          case 2:
                            ...
                            privateMembers = members.map(function (member) {
                              return {
                                userId: member,
