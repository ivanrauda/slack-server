...
exports.default = {
  ...
  Mutation: {
    createTeam: _permissions.requireAuth.createResolver(async (parent, args, { models, user }) => {
      try {
    ...
    addTeamMember: _permissions.requireAuth.createResolver(async (parent, { email, teamId }, { models, user }) => {
      try {
