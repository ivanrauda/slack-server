...
var SECRET = "kimboyune2k";
var SECRET2 = "kimboyunelovechau";
...
var resolvers = (0, _mergeGraphqlSchemas.mergeResolvers)(
// eslint-disable-next-line no-undef
...
var grapqlEnpoint = "/graphql";

app.use(grapqlEnpoint, _bodyParser2.default.json(), fileMiddleware, (0, _apolloServerExpress.graphqlExpress)(function (req) {
  return {
    schema: schema,
    context: {
      ...
      channelLoader: new _dataloader2.default(function (ids) {
        return (0, _batchFunctions.channelBatch)(ids, _models2.default, req.user);
      }),
